...
from models.load_and_scale_data import scale_data, load_single_subject_bci2aiv_data
...
def main():
    ...
    parser.add_argument("-p", "--patience", help="Parameter for EarlyStopping callback", type=int, default=10)
    ...
    model_factory = ModelFactory(dataset="BCI2aIV",
                                 ...
                                 dropout_rate=args.dropout_rate)  # num_classes is always 4 for this dataset
